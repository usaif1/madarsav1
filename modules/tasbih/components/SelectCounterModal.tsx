          ...
          <View style={styles.gridRow}>
            {presetBeads.length > 2 && (
              <TouchableOpacity
                style={[
                  styles.counterItem,
                  selectedCount === presetBeads[2] &&
                    !isCustomSelected &&
                    styles.selectedCounterItem,
                ]}
                onPress={() => onSelectPreset(presetBeads[2])}>
                <Title3Bold style={styles.counterNumber}>
                  {presetBeads[2]}
                </Title3Bold>
                <Body1Title2Medium
                  color="sub-heading"
            ...
            <TouchableOpacity
              ...
              <View
                ...
                {isCustomSelected && customValue ? (
                  <Body1Title2Medium style={styles.customBeadsValue}>
                    {customValue}
                  </Body1Title2Medium>
                ) : null}
                <CdnSvg
